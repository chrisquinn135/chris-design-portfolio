...
<PageLayout>
	...
	<div class="justify-items-center">
		<section id="top" class="max-w-4xl flex flex-col gap-16 pt-6 pb-6 md:pt-8 md:pb-16">
			<div class="flex flex-col gap-4">
				...
				<h1 class="h1">Creating a Custom Tool for Consistent Assets</h1>
			</div>
			...
			<SectionLayout id="overview">
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							The Trulioo platform comprises of a diverse range of products, each overseen by its
							own dedicated team. This led to isolated work environments, where teams operated in
							silos with limited cross-team communication. <br /><br />
							<span class={label}>
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							Ensure a unified asset experience across the platform. Assets include illustrations
							and reusable text throughout the platform.
						</div>
					</div>
					<div
						class="p-2 pb-1 sm:pb-4 pr-0 sm:pr-0 sm:p-8 bg-surface-+1 rounded-lg flex flex-col justify-center items-center text-center text-text-subdued gap-8 font-light border border-border-subdued"
					>
				...
				<ContainerLayout>
					...
					>
						<li class="flex flex-col text-center gap-2">
							<p>52</p>
							<p class="text-xl text-text-subdued font-normal">Unique illustration usages</p>
						</li>
						<li class="flex flex-col text-center gap-2">
							<p>23</p>
							<p class="text-xl text-text-subdued font-normal">Unique use-cases</p>
						</li>
						<li class="flex flex-col text-center gap-2">
							<p>2.26</p>
			...
			<SectionLayout id="ideation">
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							I addressed the issues found with the previous user journey by mapping out what the
							...
							the time investment necessary in addition to ensuring consistent asset usage.
						</div>
					</div>
					<div class={img}>
						<p>Updated user flow</p>
						<img
							src="/asset/updated-flow.png"
							alt="Consolidating different asset combinations"
							class="rounded-lg w-full"
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							Several tools were suggested to house our asset repository, including tools like
			...
			<SectionLayout id="design">
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							Once the initial designs were complete, I ran moderated user tests with three
							designers and iterated on the designs based on the gathered insights.
						</div>
					</div>
				</ContainerLayout>
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							The first iteration of designs featured a tag filter system that allowed users to
			...
			<SectionLayout id="dev">
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							The following section is a quick dive into the technical implementation of the plugin.
							If you're more interested in the designs, feel free to jump to the <a
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							...
							use case information within a JSON file for quick lookup.
						</div>
					</div>
					<div class={img}>
						<img
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class={body}>
							...
							validate that each item is an <code class={code}>"INSTANCE"</code> object.
							<br /><br />
			...
			<SectionLayout id="impact">
					...
					<div class={div}>
						...
						<div class="flex flex-col gap-4">
							<p class={body}>
								...
								several ideas in the pipeline for the future.
							</p>
						</div>
					</div>
					<div class={imgPad}>
						<p>KPI results since release</p>
						<img
							src="/asset/improve.png"
							alt="Individual asset screen improvements"
							class="rounded-lg w-full"
						/>
					</div>
				...
				<ContainerLayout>
					<div class={div}>
						...
						<div class="flex flex-col gap-4">
							<p class={body}>
								We are still experimenting and collecting metrics on how the Asset Manager can be
								improved in the future adoption and impact-wise, but as a start, here are some
								things we're looking at for the future of the Asset Manager!
							</p>
							<div
								class="flex flex-col gap-px px-4 py-2 rounded-lg border border-border-subdued bg-surface-0"
							>
								<p class={label}>Cross-functional implementation</p>
								<p class={body}>
									Being able to integrate to the entire design team is great, but what if we could
							...
							<div
								class="flex flex-col gap-px px-4 py-2 rounded-lg border border-border-subdued bg-surface-0"
							>
								<p class={label}>Cloud database integration</p>
								<p class={body}>
									Currently, component keys and asset information is being stored locally within the
									plugin source code. Moving it to an external database would allow designers to
									update, add and remove assets without releasing a new version of the plugin.
								</p>
							</div>
							<div
								class="flex flex-col gap-px px-4 py-2 rounded-lg border border-border-subdued bg-surface-0"
							>
								<p class={label}>Analytics and metrics tracking</p>
								<p class={body}>
									The Asset Manager could track all insertions of assets across all projects,
					...
					<div class={div}>
						...
						<div class="flex flex-col gap-4">
							<p class={body}>
								...
								>. Because this project affects the design process of all designers in our team, I
